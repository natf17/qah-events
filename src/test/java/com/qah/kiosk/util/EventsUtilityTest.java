...
public class EventsUtilityTest {
	...
	@Test
	public void transformGenericToSingleTranslatedEvent_givenNonexistingLanguage_ReturnsNull() {
		GenericEvent ge = new GenericEvent();
		ge.setComments("Comments");
		ge.setDataLanguage("sample");
		ge.setDefaultDataLang("defaultDataLanguage");
		...
		SingleTranslatedEvent ste = EventsUtility.transformGenericToSingleTranslatedEvent(ge, "sp");
		
		Assert.assertTrue(ste == null);
